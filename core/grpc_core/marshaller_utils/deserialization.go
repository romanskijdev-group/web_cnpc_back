...
func (m *Deserialization) OptionalInt32(pbInt32 *wrapperspb.Int32Value) *int32 {
	if pbInt32 != nil {
		return &pbInt32.Value
	}
	return nil
}
...
func (m *Deserialization) OptionalStringTimeOnlyDate(pbTime *wrapperspb.StringValue) *string {
	if pbTime != nil {
		...
		if err != nil {
			log.Println("🔴 error OptionalStringTimeOnlyDate:parsedTime: ", err)
