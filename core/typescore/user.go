...
type UsersProviderControl struct {
	...
	VKID                *int64         `gorm:"unique;index;column:vk_id" json:"vk_id" db:"vk_id"`                                                                                   // Идентификатор пользователя в VK
...
type ShortUserInfo struct {
	...
	VKID       *int64  `json:"vk_id,omitempty" db:"vk_id"`             // Идентификатор пользователя в Telegram
